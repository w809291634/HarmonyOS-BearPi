...
hi_u32 at_cmd_excute(const at_cmd_func *cmd_func, at_cmd_attr *cmd_parsed)
{
    ...
    if (cmd_parsed->at_cmd_type == AT_CMD_TYPE_TEST) {
        LOG_D("[%s] %d AT_CMD_TYPE_TEST",__func__,__LINE__);
        ...
        LOG_D("[%s] %d AT_CMD_TYPE_QUERY",__func__,__LINE__);
        ...
        LOG_D("[%s] %d AT_CMD_TYPE_SETUP",__func__,__LINE__);
        ...
        LOG_D("[%s] %d AT_CMD_TYPE_EXE",__func__,__LINE__);
...
hi_u32 at_func_process(hi_char *out_cmd_line, at_cmd_attr *cmd_parsed)
{
    ...
    LOG_D("[%s] out_cmd_line:%s",__func__,out_cmd_line);
    ...
    if (cmd_func != HI_NULL) {
        LOG_D("[%s] at_cmd_name:%s",__func__,cmd_func->at_cmd_name);
        ...
        LOG_D("[%s] %d at_cmd_excute ret:%d",__func__,__LINE__,ret);
    } else {
        ret = HI_ERR_FAILURE;
...
hi_u32 at_cmd_process(const hi_char *at_cmd_line)
{
    ...
    LOG_D("[%s] at_cmd_line:%s",__func__,at_cmd_line);
